...
| --- | --- | --- | --- |
| OpenAI GPT-3.5 Turbo | 175 billion | 4096 | $0.002 |
| OpenAI GPT-4 | **~1 trillion** | 8192 <br>(32k version coming "soon") | $0.03-0.12 |
...
- Ask GPT to generate the selectors.
...
- Do you trust GPT to generate code that's secure unsupervised?
    [**You shouldn't**]{.red .fragment .fade-up}
...
* It returned valid JSON, which we can use directly.
* Each request cost about $0.002.  (2/10 of a cent)
* Each of the three page variants returned the same data from the same code.
